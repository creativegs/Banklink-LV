...
include Banklink into your controller and make Helper for view:
    ...
    @helper = Helper.new(TRANS_ID, YOUR_SENDER_ID, options)
    
Then create Notification controller for notify and include Banklink. Then you can notify:
  
    notify = Banklink::Notification.new(params)
    @text
